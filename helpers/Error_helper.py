...
def _Get_error(content, etype, status):
#     print(ERRORS[etype][0],":",ERRORS[etype][1])
#     print("Content passed:",content)
    return Response('{"Error": "'+ERRORS[etype][0]+'", "Message": "'+ERRORS[etype][1]+'", "Content": "'+content+'"}', status=status, mimetype='application/json')
